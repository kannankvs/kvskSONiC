...
| **PINS GE Netlink** | SONiC supports Packet I/O on Linux netdev interfaces but this does not meet some unique requirements of P4Runtime application. This feature details the requirements and captures the design changes necessary to meet the new requirements. | [978](https://github.com/sonic-net/SONiC/pull/978) | |
