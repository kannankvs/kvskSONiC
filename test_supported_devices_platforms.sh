...
echo "| 1    | echo "${DEFID_accton}"    	| AS4630-54PE    		| Broadcom    | Helix 5           | 48x1G + 4x25G + 2x100G  | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 2    | echo "${DEFID_accton}"    	| AS5712-54X     		| Broadcom    | Trident 2         | 72x10G                  | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 3    | echo "${DEFID_accton}"    	| AS5812-54X     		| Broadcom    | Trident 2         | 72x10G                  | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 4    | echo "${DEFID_accton}"    	| AS5835-54T     		| Broadcom    | Trident 3         | 48x10G + 6x100G         | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 5    | echo "${DEFID_accton}"    	| AS5835-54X     		| Broadcom    | Trident 3         | 48x10G + 6x100G         | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 6    | echo "${DEFID_accton}"    	| AS6712-32X     		| Broadcom    | Trident 2         | 32x40G                  | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 7    | echo "${DEFID_accton}"    	| AS7116-54X     		| Nephos      | Taurus            | 48x25G + 6x100G         | [SONiC-ONIE-Nephos]($(echo "${ARTF_NPH}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-nephos.bin/')) |" >> supported_devices_platforms.md
echo "| 8    | echo "${DEFID_accton}"    	| AS7312-54X     		| Broadcom    | Tomahawk          | 48x25G + 6x100G         | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
...
echo "| 20   | echo "${DEFID_alpha}" | SNH60A0-320Fv2      	| Broadcom    | Tomahawk          | 32x100G                 | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 21   | echo "${DEFID_alpha}" | SNH60B0-640F        	| Broadcom    | Tomahawk 2         | 64x100G                 | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 22   | echo "${DEFID_alpha}" | BES2348T        	| Broadcom    | Trident 3 X2         | 48x1G+4x25G                 | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 23   | echo "${DEFID_arista}"        | 7050QX-32      		| Broadcom    | Trident 2         | 32x40G                  | [SONiC-Aboot-Broadcom]($(echo "${ARTF_BFT}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-aboot-barefoot.swi/')) |" >> supported_devices_platforms.md
echo "| 24   | echo "${DEFID_arista}"        | 7050QX-32S     		| Broadcom    | Trident 2         | 32x40G                  | [SONiC-Aboot-Broadcom]($(echo "${ARTF_BFT}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-aboot-barefoot.swi/')) |" >> supported_devices_platforms.md
echo "| 25   | echo "${DEFID_arista}"        | 7050CX3-32S     		| Broadcom    | Trident 3         | 32x100G + 2x10G         | [SONiC-Aboot-Broadcom]($(echo "${ARTF_BFT}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-aboot-barefoot.swi/')) |" >> supported_devices_platforms.md
echo "| 26   | echo "${DEFID_arista}"        | 7060CX-32S     		| Broadcom    | Tomahawk          | 32x100G + 2x10G         | [SONiC-Aboot-Broadcom]($(echo "${ARTF_BFT}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-aboot-barefoot.swi/')) |" >> supported_devices_platforms.md
echo "| 27   | echo "${DEFID_arista}"        | 7060DX4-32       		| Broadcom    | Tomahawk 3        | 32x400G + 2x10G         | [SONiC-Aboot-Broadcom]($(echo "${ARTF_BFT}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-aboot-barefoot.swi/')) |" >> supported_devices_platforms.md
echo "| 28   | echo "${DEFID_arista}"        | 7060PX4-32       		| Broadcom    | Tomahawk 3        | 32x400G + 2x10G         | [SONiC-Aboot-Broadcom]($(echo "${ARTF_BFT}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-aboot-barefoot.swi/')) |" >> supported_devices_platforms.md
...
echo "| 89   | Mitac         | LY1200-B32H0-C3		| Broadcom    | Tomahawk          | 32x100G                 | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 90   | Netberg       | Aurora 610        	| Intel       | Tofino BFN-T10-032D-020  | 48x 25G + 8x 100G | [SONiC-ONIE-Barefoot]($(echo "${ARTF_BFT}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-barefoot.bin/')) |" >> supported_devices_platforms.md
...
echo "| 93   | Nvidia        | SN2201         	| Nvidia | Spectrum          | 48x1G + 4x100G         | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 94   | Nvidia        | SN2410         	| Nvidia | Spectrum          | 48x25G + 8x100G         | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 95   | Nvidia        | SN2700         	| Nvidia | Spectrum          | 32x100G                 | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 96   | Nvidia        | SN3420         	| Nvidia | Spectrum 2        | 48x25G + 12x100G        | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 97   | Nvidia        | SN3700         	| Nvidia | Spectrum 2        | 32x200G                 | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 98   | Nvidia        | SN3700C        	| Nvidia | Spectrum 2        | 32x100G                 | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 99   | Nvidia        | SN3800         	| Nvidia | Spectrum 2        | 64x100G                 | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 100   | Nvidia        | SN4600C        	| Nvidia | Spectrum 3        | 64x100G                 | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 101   | Nvidia        | SN4700         	| Nvidia | Spectrum 3        | 32x400G                 | [SONiC-ONIE-Mellanox]($(echo "${ARTF_MLNX}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-mellanox.bin/')) |" >> supported_devices_platforms.md
echo "| 102   | Pegatron      | Porsche         | Nephos      | Taurus            | 48x25G + 6x100G         | [SONiC-ONIE-Nephos]($(echo "${ARTF_NPH}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-nephos.bin/')) |" >> supported_devices_platforms.md
echo "| 103   | Quanta        | T3032-IX7      	| Broadcom    | Trident 3         | 32x100G                 | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
echo "| 104   | Quanta        | T4048-IX8      	| Broadcom    | Trident 3         | 48x25G + 8x100G         | [SONiC-ONIE-Broadcom]($(echo "${ARTF_BRCM}" | sed 's/format=zip/format=file\&subpath=\/target\/sonic-broadcom.bin/')) |" >> supported_devices_platforms.md
